...
class Example extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.image('tiles', 'Illustration_sans_titre.png');
    }
    ...
    create ()
    {
        ...
        this.dungeon.rooms.forEach(function (room) {
            ...
            {
                this.map.putTileAt(5, x + doors[i].x, y + doors[i].y);
            }
        ...
        // do for the example.
        this.layer.setCollisionByExclusion([ 5, 7, 8, 9, 13 ]);
