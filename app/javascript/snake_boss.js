...
export class SnakeBoss extends Phaser.Physics.Arcade.Sprite {
  ...
  update () {
    ...
    if (this.getHealth() == 0) {
      ...
      // on recolle la barre de vie au boss
      this.healthBar.bg.setX(this.x - 200)
      this.healthBar.bg.setY(this.y - 15)
      this.healthBar.bar.setX(this.x - 200)
      this.healthBar.bar.setY(this.y - 15)

      // les déplacements sont à revoir
